...
describe('Object(): conditions', () => {
  it('invalid key in condition should fail', async () => {
    ...
    await helper.throw(() => object.conditions({ age: { gt: 'name' } }), `Object has no key 'age'.`);
    await helper.throw(() => object.conditions({ name: { gt: 'age' } }), `Object has no key 'age'.`);
  });

  it('invalid condition method should fail', async () => {
    const object = validator.Object({ name: validator.String() });
    await helper.throw(() => object.conditions({ name: { invalid: 'name' } }), `Object has no condition method 'invalid'.`);
  });

  describe('greater condition', () => {
    it('conditions() fail and verify', async () => {
      const object = validator.Object({ bigger: validator.Integer(), smaller: validator.Integer() })
        .conditions({ smaller: { gt: 'bigger' } });

      const invalid = { bigger: 10, smaller: 5 };
      await helper.throw(object.validate(invalid), { smaller: `Must be greater than bigger.` });
  ...
  describe('greater or equal condition', () => {
    it('conditions() fail and verify', async () => {
      ...
      const invalid = { bigger: 10, smaller: 5 };
      await helper.throw(object.validate(invalid),{ smaller: `Must be greater or equal than bigger.` });
  ...
  describe('less condition', () => {
    it('conditions() fail and verify', async () => {
      ...
      await helper.throw(object.validate(invalid), { smaller: `Must be less than bigger.` });
  ...
  describe('less or equal condition', () => {
    it('conditions() fail and verify', async () => {
      ...
      const invalid = { bigger: 5, smaller: 10 };
      await helper.throw(object.validate(invalid), { smaller: `Must be less or equal than bigger.` });
  ...
  describe('equals condition', () => {
    it('conditions() fail and verify', async () => {
      ...
      const invalid = { bigger: 5, smaller: 10 };
      await helper.throw(object.validate(invalid), { smaller: `Must equal bigger.` });
  ...
  describe('notEquals condition', () => {
    it('conditions() fail and verify', async () => {
      ...
      await helper.throw(object.validate(invalid), { smaller: `Must not equal bigger.` });
  ...
  describe('xor condition', () => {
    it('conditions() fail and verify', async () => {
      const object = validator.Object({ bigger: validator.Integer().required(false), smaller: validator.Integer().required(false) })
        .conditions({ smaller: { xor: 'bigger' } });

      const invalid = { bigger: 5, smaller: 10 };
      await helper.throw(object.validate(invalid), { smaller: `Only bigger or smaller can be set.` });
  ...
  describe('dependsOn condition', () => {
    it('conditions() fail and verify', async () => {
      ...
      await helper.throw(object.validate(invalid), { smaller: `Depends on bigger.` });
  ...
  it('test multiple conditions', async () => {
    ...
    }).gt('bigger', 'smaller').dependsOn('bigger', 'smaller');
