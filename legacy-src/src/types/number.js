...
const validateNumber = async (value, schema) => {
  ...
  if (schema._min && value < schema._min)
    throw message.get(
      schema._language,
      schema._messages,
      'number',
  ...
  if (schema._max && value > schema._max)
    throw message.get(
      schema._language,
      schema._messages,
      'number',
  ...
  if (schema._less && value >= schema._less)
    throw message.get(
      schema._language,
      schema._messages,
      'number',
  ...
  if (schema._greater && value <= schema._greater)
    throw message.get(
      schema._language,
      schema._messages,
      'number',
  ...
  if (schema._positive && value <= 0)
    throw message.get(schema._language, schema._messages, 'number', 'positive');
  if (schema._negative && value >= 0)
    throw message.get(schema._language, schema._messages, 'number', 'negative');
