...
describe('Object()', () => {
  ...
  it('invalid data type should fail', async () => {
    await helper.throw(
      validator.Object({ name: validator.String() }).validate(['test']),
      `Must be an object.`
    );
  });
  ...
  it('invalid data should fail', async () => {
    ...
    await helper.throw(object.validate({ name: 10 }), {
  ...
  it('min should fail and verify', async () => {
    ...
    const object = validator
      ...
      .min(2);
    await helper.throw(
      object.validate(invalid),
      'Object must have at least 2 keys.'
    );
  ...
  it('max should fail and verify', async () => {
    ...
    await helper.throw(
      object.validate(invalid),
      'Object must have at most 1 keys.'
    );
  ...
  it('length should fail and verify', async () => {
    ...
    await helper.throw(
      object.validate(invalid),
      'Object must have exactly 1 keys.'
    );
